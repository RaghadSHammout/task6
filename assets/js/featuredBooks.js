async function fetchFeaturedBooks() {
    ...
    try {
        const response = await fetch('https://wolnelektury.pl/api/authors/adam-mickiewicz/kinds/liryka/parent_books/');
        ...
        featuredBooks.forEach(book => {
            const card = `
                <div class="col-md-3 mb-4 d-flex justify-content-center mt-5">
                    <div class="card border-0 text-center book-card">
                        <div class="d-flex justify-content-center align-items-center book-bg">
                            <img src="${book.simple_thumb}" class="rounded-3 shadow-sm book-img" alt="${book.title}">
                        </div>
                        <div class="card-body bg-light-color">
